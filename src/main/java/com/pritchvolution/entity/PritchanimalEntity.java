...
public class PritchanimalEntity extends Animal {
    ...
    public static void initialize(LevelAccessor world, double x, double y, double z, PritchanimalEntity entity) {
        ...
        if (!entity.getEntityData().get(PritchanimalEntity.DATA_isInitialized)) {
            ...
            entity.getEntityData().set(PritchanimalEntity.DATA_POSITION_HeadOffset_z, (int) ((-10) * ScaleNeckY * Math.sin(Math.toRadians(entity.getEntityData().get(PritchanimalEntity.DATA_ROTATION_Neck_x)))));
            ScaleBodyY = (float) entity.getEntityData().get(PritchanimalEntity.DATA_SCALE_Body_y) / 100;
            entity.getEntityData().set(PritchanimalEntity.DATA_POSITION_Head_y, (int) (12 * (ScaleBodyY - 1) - 12 * ScaleBodyY * Math.sin(Math.toRadians(entity.getEntityData().get(PritchanimalEntity.DATA_ROTATION_Body_x)))));
            entity.getEntityData().set(PritchanimalEntity.DATA_POSITION_Head_y, (int) (12 * (ScaleBodyY - 1) - 12 * ScaleBodyY * Math.sin(Math.toRadians(entity.getEntityData().get(PritchanimalEntity.DATA_ROTATION_Body_x)))));
